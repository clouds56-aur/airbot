...
The legacy airbot-configure package has no embedded md5sums manifest, so its
recipe verifies the complete Debian archive with the recorded SHA-256 instead.
